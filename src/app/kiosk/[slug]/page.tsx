      ...
      <div className="flex flex-1 flex-col items-center justify-center px-6 py-8">
        ...
        {showSuccess && (
          <div className="mb-8 w-full max-w-md">
            <div className="rounded-lg border border-teal-200 bg-teal-50 px-8 py-10 text-center">
              <p className="text-4xl font-bold text-teal-900">✓ You're on the list!</p>
        ...
        <div className="w-full max-w-md">
          <form
            ...
            className="rounded-xl border border-slate-300 bg-white p-8 shadow-sm"
          >
            {/* Name Input */}
            <div className="mb-6">
              ...
              <input
                ...
                placeholder="John"
                className="w-full rounded-lg border border-slate-300 bg-white px-4 py-3 text-lg text-slate-900 placeholder-slate-400 focus:border-teal-700 focus:outline-none"
              />
            </div>
            ...
            <div className="mb-6">
              ...
              <div className="inline-flex items-center gap-1 rounded-lg border border-slate-300 bg-slate-50 p-1">
                <button
                  ...
                  className="px-3 py-2 text-slate-600 hover:bg-slate-200 hover:text-slate-900"
                >
                  −
                </button>
                <div className="w-10 text-center text-lg font-bold text-teal-700">
                  {size}
                </div>
                <button
                  type="button"
            ...
            <button
              ...
              className="w-full rounded-lg bg-teal-700 px-4 py-3 text-lg font-semibold text-white transition hover:bg-teal-800 disabled:opacity-60"
            >
